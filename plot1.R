...
# -- Construct a histogram of global active power on the png device, save as "plot1.png" 
defaultPar <- par()
png(file="plot1.png",width= 480, height= 480)
par(mgp = c(2, 0.7, 0), cex.lab = .7, cex.axis = .7)
hist(powerDFsub$Global_active_power, col = "orangered", breaks = 12, xlab = NULL, main = NULL)
title(main = "Global Active Power", xlab = "Global Active Power (kilowatts)", cex.main = .8, font.main = 2)
dev.off()
par(defaultPar)